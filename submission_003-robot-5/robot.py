...
def get_robot_name():
    """
    Asks for user input and saves it as robot_name
    """
...
def call_command(command_name, command_arg, robot_name):
    """
    This funtion triggers movement function by reading keywords in the user input. command_name
    is the first element in the command string. command_arg is an integer that specifies the size of a movement.
    robot_name is passed for output strings.
    """
